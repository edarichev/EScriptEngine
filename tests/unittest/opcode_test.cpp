...
{
    TCode code1;
    code1.operand1.type = SymbolType::Integer;
    code1.operand1.intValue = 15;
    code1.operand2.type = SymbolType::Real;
    code1.operand2.realValue = 16;
    assert(code1.operand1.intValue == 15);
    assert(code1.operand1.type == SymbolType::Integer);
    assert(code1.operand2.realValue == 16);
    assert(code1.operand2.type == SymbolType::Real);
}
