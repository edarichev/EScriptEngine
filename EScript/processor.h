...
public:
    ...
    void run()
    {
        ...
        while (_pc < _memoryLimit) {
            ...
            case OpCode::LD_NULL: ld_null(); break;
            case OpCode::STNOTEQ: stnoteq(); break;
            case OpCode::STNCO: stnco(); break;
            case OpCode::CTOR: ctor(); break;
            case OpCode::CHTYPE: chtype(); break;
...
private:
    ...
    void stnoteq();
    /**
     * @brief Вынимает из стека два операнда, сравнивает их: если первый 
     * равен NULL, в стек возвращается второй, и наоборот.
     */
    void stnco();
    /**
...
public:
    ...
    void pushToStack(const std::string &value);
