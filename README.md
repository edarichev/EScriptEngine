...
## Строки
Поскольку современный Интернет немыслим без картинок-символов Unicode старше 0xFFFF, внутреннее представление строки - 32 бита. Поэтому вам не придётся возиться с кодовыми точками.
