...
Некоторых возможностей не будет в силу отсутствия прктической неободимости для поставленных целей.

## Текущая версия
0.2

До версии 1.0 могут вноситься значительные изменения без предупреждения.
...
то вставляется нужное число пустых элементов.
