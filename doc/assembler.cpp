...
const std::string Assembler::_opCodeNames[] = {
    ...
    "ADDST", "MULST", "DIVST", "SUBST", 
    "POP A", "CMP A, D64", "STLOC M", "NEG", 
...
OpCode Assembler::_opCodes[] = {
    ...
    OpCode::ADDST, OpCode::MULST, OpCode::DIVST, OpCode::SUBST, 
    OpCode::POP_A, OpCode::CMP_A_D64, OpCode::STLOC_M, OpCode::NEG, 
